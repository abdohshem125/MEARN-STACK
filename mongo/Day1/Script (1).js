...
show collections
db.getCollectionNames({firstName : "noha"})
db.instructors.insert({id:11, firstName : "abdo" , age : 24})
db.instructors.insertOne({firstName : "ahmed" , age : 20})

db.instructors.insert({})

db.instructors.insertOne({age : 20 , salary: 10000})

db.instructors.find({})

db.instructors.find({}, {firstName:1 , lastName:1 ,address: 1 , _id:0})

db.instructors.find({age :{$eq : 21}} , { _id:0,firstName:1 , "address.city":1 })

//Display firstName and age for instructors live in Mansoura city.
db.instructors.find({"address.city" : {$eq : "mansoura"}} , { firstName:1 , age:1 ,_id:0})

//db.instructors.find({firstName:"mona"},{lastName:"ahmed" ,firstName:1},{firstName:1,lastName:1})

db.instructors.find({firstName:"mona"},{lastName:""},{firstName:1,lastName:1})
